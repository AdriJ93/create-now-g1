...
function Agb() {
  return (
    <Layout>
      <div className="agb">
        Allgemeine Geschäftsbedingungen der Firma Create Now
        <br />
        <br />
        ...
        Bestellungen über unseren Internetshop http://www.create-now.net .<br />
        <br />
        <b>
        ...
        <br />
        <br />
        Die Annahme des Angebots erfolgt schriftlich oder in Textform oder durch
        Übersendung der bestellten Ware innerhalb von einer Woche. Nach
        ...
        <div>
          ...
          Daten.
          <br />
          7ö Verbindliche Absendung der Bestellung durch Anklicken des Buttons
        ...
        (Eingangsbestätigung). Diese stellt noch keine Annahme des Angebotes
        dar. Die Annahme des Angebots erfolgt schriftlich, in Textform oder
        durch Übersendung der bestellten Ware innerhalb einer Woche.
        <br />
        <br />
        ...
        E-Mail zu. Die AGB können Sie jederzeit auch unter http://create-now.net
        ...
        erst mit der Übergabe der Sache an den Käufer auf diesen über. <br />
        <br />

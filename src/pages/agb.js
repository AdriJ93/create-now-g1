...
function Agb() {
  return (
    <Layout>
      <div className="agb" style={{ backgroundImage: `url(${TitleWhite})` }}>
        <div className="agb-container">
          <h1>Allgemeine Geschäfts-bedingungen der Firma Create Now</h1>
          <div className="scroll-div">
            ...
            Bestellungen über unseren Internetshop http://www.create-now.net .
            <br />
            <br />
            <b>
            ...
            durch Übersendung der bestellten Ware innerhalb von einer Woche.
            ...
            <div>
              ...
              eingegebenen Daten.
              <br />
              7ö Verbindliche Absendung der Bestellung durch Anklicken des
            ...
            E-Mail (Eingangsbestätigung). Diese stellt noch keine Annahme des
            Angebotes dar. Die Annahme des Angebots erfolgt schriftlich, in
            Textform oder durch Übersendung der bestellten Ware innerhalb einer
            Woche.
            <br />
            <br />
            ...
            http://create-now.net einsehen. Ihre Bestelldaten sind aus
            ...
            und sonstige Preisbestandteile. Hinzu kommen etwaige Versandkosten.
            <br />
            <br />
            (2) Der Verbraucher hat die Möglichkeit der Zahlung per Bankeinzug,
            PayPal, Kreditkarte( Visa, Mastercard ) .<br />
            <br />
            <br />
            <p>§4 Lieferung</p>

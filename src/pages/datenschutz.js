    ...
    <Layout>
      <div className="datenschutz">
        ...
        <p>
          ...
          (nachfolgend &bdquo;Shopify&ldquo;).
        </p>{" "}
        <p>
          Shopify ein Tool zum Erstellen und zum Hosten von Webseiten. Wenn Sie
          unsere Website besuchen, erfasst Shopify Ihre IP-Adresse sowie
